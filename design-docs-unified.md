...
- `LOVABLE_API_KEY` 기반 LLM 호출 + JSON schema 검증
...
- AI/신호: `LOVABLE_API_KEY`, `BRIGHTDESK_SIGNAL_WEIGHTS_JSON` 혹은 `BRIGHTDESK_WEIGHT_*`
...
- 권장: `LOVABLE_API_KEY`, `BRIGHTDESK_CRON_ALERT_COOLDOWN_MINUTES`, `BRIGHTDESK_CRON_ESCALATION_CONSECUTIVE_FAILURES`, `BRIGHTDESK_CRON_WEBHOOK_URL`, `BRIGHTDESK_CRON_WEBHOOK_URLS`
